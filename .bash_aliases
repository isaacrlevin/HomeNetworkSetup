...
alias fixsecrets='sudo chown -R root:root /home/pi/docker/secrets ; sudo chmod -R 600 /home/pi/docker/secrets'

# STACK UP AND DOWN
alias 1down='cd /home/pi/docker ; dcdown1v ; dcdown1'
alias 1up='cd /home/pi/docker ; sudo docker network create t1_proxy ; dcrec1 plexms ; dcup1 ; dcup1v'
alias 2down='cd /home/pi/docker ; dcdown2v ; dcdown2'
alias 2up='cd /home/pi/docker ; sudo docker network create --gateway 192.168.91.1 --subnet 192.168.91.0/24 socket_proxy ; sudo docker network create --gateway 192.168.90.1 --subnet 192.168.90.0/24 t2_proxy ; dcrec2 plexms ; dcup2 ; dcup2v'

# DOCKER TRAEFIK 1
alias dcrun1='cd /home/pi/docker ; sudo docker-compose -f /home/pi/docker/docker-compose-t1.yml '
alias dclogs1='cd /home/pi/docker ; sudo docker-compose -f /home/pi/docker/docker-compose-t1.yml logs -tf --tail="50" '
...
alias dcpull1='cd /home/pi/docker ; sudo docker-compose -f /home/pi/docker/docker-compose-t1.yml pull'

# DOCKER TRAEFIK 1 VPN
alias dcrun1v='cd /home/pi/docker ; sudo docker-compose -f /home/pi/docker/docker-compose-t1-vpn.yml '
alias dclogs1v='cd /home/pi/docker ; sudo docker-compose -f /home/pi/docker/docker-compose-t1-vpn.yml logs -tf --tail="50" '
...
alias dcpull1v='cd /home/pi/docker ; sudo docker-compose -f /home/pi/docker/docker-compose-t1-vpn.yml  pull'

# DOCKER TRAEFIK 2
alias dcrun2='cd /home/pi/docker ; sudo docker-compose -f /home/pi/docker/docker-compose-t2.yml '
alias dclogs2='cd /home/pi/docker ; sudo docker-compose -f /home/pi/docker/docker-compose-t2.yml logs -tf --tail="50" '
...
alias dcpull2='cd /home/pi/docker ; sudo docker-compose -f /home/pi/docker/docker-compose-t2.yml  pull'

# DOCKER TRAEFIK 2 VPN
alias dcrun2v='cd /home/pi/docker ; sudo docker-compose -f /home/pi/docker/docker-compose-t2-vpn.yml '
alias dclogs2v='cd /home/pi/docker ; sudo docker-compose -f /home/pi/docker/docker-compose-t2-vpn.yml logs -tf --tail="50" '
...
alias dcpull2v='cd /home/pi/docker ; sudo docker-compose -f /home/pi/docker/docker-compose-t2-vpn.yml  pull'
...
alias dsup='sudo docker stack deploy --compose-file /home/pi/docker/docker-compose-swarm.yml zstack'
